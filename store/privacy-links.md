...
S5-05 may later add a custom-domain redirect without changing which document is canonical.
...
| Chrome Web Store listing → "Privacy policy" field   | Privacy Policy URL            | S4-23 / S4-24 | 📝 copy ready (S4-23); set at submission (S4-24) |
| Microsoft Edge Add-ons listing → privacy field      | Privacy Policy URL            | S4-23 / S4-24 | 📝 copy ready (S4-23); set at submission (S4-24) |
| Firefox AMO listing → privacy field                 | Privacy Policy URL            | S5-04         | 🅿️ parked                                        |
